...
import pandas as pd
import numpy as np
from primary_functions import get_innings,runcounter,get_ob_states,create_matrix
...
def display_matrix(matrix_dict):
    # Initialize an 8x3 matrix with zeros
    matrix = np.zeros((8, 3))
    
    # Fill the matrix with ratios
...
if __name__ == "__main__":
        ...
        display_matrix(matrix_dict_team)
        print(calculate_difference(team))